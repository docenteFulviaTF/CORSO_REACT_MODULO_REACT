    ...
    <BrowserRouter>
      <div className="box">
        <nav className="bottone-riga">
          <Link className="bottone bottone--secondario" to="/">
            Home
          </Link>
          <Link className="bottone bottone--secondario" to="/chi-siamo">
            Chi siamo
          </Link>
          <Link className="bottone bottone--secondario" to="/contatti">
            Contatti
          </Link>
        </nav>
