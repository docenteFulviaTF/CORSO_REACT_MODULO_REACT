...
// function reducer(state, action) {
//   if (action.type === 'avanti') {
//     // Cerca il colore corrente come CHIAVE nell'oggetto e restituisce il suo VALORE
//     return prossimoColore[state] || state;
//   }
//   return state;
// }
